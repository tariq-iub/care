                                        ...
                                        <form id="wizardVerticalForm1" novalidate="novalidate" data-wizard-form="1">
                                            <div class="row g-3">
                                                ...
                                                <div class="d-flex justify-content-between">
                                                    ...
                                                    <button class="btn btn-primary" onclick="return false;">Save Setup</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
            ...
            <div class="col-12 col-xl-2 order-1 order-xl-2 mb-4 mb-xl-0">
                <div class="sticky-top mt-xl-4" style="top:80px;">
                    ...
                    <ul class="nav nav-vertical flex-column doc-nav" data-doc-nav="data-doc-nav">
                        <li class="nav-item"><a class="nav-link" href="#component-drive">Drive Type of Component</a></li>
                        <li class="nav-item"><a class="nav-link" href="#machine-driven">Motor Driven Machine</a></li>
                        <li class="nav-item"><a class="nav-link" href="#motor-setup">Motor Setup</a></li>
                        <li class="nav-item"><a class="nav-link" href="#coupled-component">Coupled Component</a></li>
                        <li class="nav-item"><a class="nav-link" href="#gearbox-setup">Gearbox Setup</a></li>
                        <li class="nav-item"><a class="nav-link" href="#driven-component">Driven Component</a></li>
                        <li class="nav-item"><a class="nav-link" href="#pump-component">Pump Component</a></li>
                        <li class="nav-item"><a class="nav-link" href="#pump-setup">Pump Setup</a></li>
                    </ul>
                </div>
            </div>
        </div>
