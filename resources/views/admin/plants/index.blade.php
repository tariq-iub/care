                                    ...
                                    <form id="wizardVerticalForm1" novalidate="novalidate" data-wizard-form="1">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" class="form-control" id="contact-title" name="contact-title" required>
                                            </div>
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" class="form-control" id="fax-number" name="fax-number">
                                            </div>
                                            <div class="col-md-12">
                                    ...
                                    <form id="wizardVerticalForm3" novalidate="novalidate" data-wizard-form="3">
                                        <div class="row g-3">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" class="form-control" id="service-rep-name" name="service-rep-name" required>
                                            </div>
                                            <div class="col-md-12">
                                                <label for="service-rep-address" class="form-label">Address</label>
                                                <input type="text" class="form-control" id="service-rep-address" name="service-rep-address" required>
                                            </div>
                                            <div class="col-md-12">
                                                <label for="service-rep-city" class="form-label">City</label>
                                                <input type="text" class="form-control" id="service-rep-city" name="service-rep-city" required>
                                            </div>
                                            <div class="col-md-12">
                                                <label for="service-rep-state" class="form-label">State/Province</label>
                                                <input type="text" class="form-control" id="service-rep-state" name="service-rep-state" required>
                                            </div>
                                            <div class="col-md-12">
                                                <label for="service-rep-zip" class="form-label">Zip/Post Code</label>
                                                <input type="text" class="form-control" id="service-rep-zip" name="service-rep-zip" required>
                                            </div>
                                            <div class="col-md-12">
                                                <label for="service-rep-country" class="form-label">Country</label>
                                                <input type="text" class="form-control" id="service-rep-country" name="service-rep-country" required>
                                            </div>
                                            <div class="col-md-12">
                                                <label for="service-rep-contact-name" class="form-label">Contact Name</label>
                                                <input type="text" class="form-control" id="service-rep-contact-name" name="service-rep-contact-name" required>
                                            </div>
                                            <div class="col-md-12">
                                                <label for="service-rep-contact-title" class="form-label">Contact Title</label>
                                                <input type="text" class="form-control" id="service-rep-contact-title" name="service-rep-contact-title" required>
                                            </div>
                                            <div class="col-md-12">
                                                <label for="service-rep-phone-number" class="form-label">Phone Number</label>
                                                <input type="text" class="form-control" id="service-rep-phone-number" name="service-rep-phone-number" required>
                                            </div>
                                            <div class="col-md-12">
                                                <label for="service-rep-alt-phone-number" class="form-label">Alt Phone Number</label>
                                                <input type="text" class="form-control" id="service-rep-alt-phone-number" name="service-rep-alt-phone-number">
                                            </div>
                                            <div class="col-md-12">
                                                <label for="service-rep-fax-number" class="form-label">Fax Number</label>
                                                <input type="text" class="form-control" id="service-rep-fax-number" name="service-rep-fax-number">
                                            </div>
                                            <div class="col-md-12">
                                                <label for="service-rep-email-address" class="form-label">Email Address</label>
                                                <input type="email" class="form-control" id="service-rep-email-address" name="service-rep-email-address" required>
                                            </div>
                                        </div>
                                    </form>
                                </div>
