                                    ...
                                    <form id="wizardVerticalForm1" novalidate="novalidate" data-wizard-form="1">
                                        <div class="row g-3">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" class="form-control" id="company-name" name="company_name" required value={{$company->company_name}}>
                                            </div>
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" class="form-control" id="state" name="state" required value={{$company->state}} >
                                            </div>
                                            <div class="col-md-12">
                                                <label for="zip" class="form-label">Zip/Post Code</label>
                                                <input type="text" class="form-control" id="zip" name="zip" required value={{$company->zip}} >
                                            </div>
                                            <div class="col-md-12">
                                                <label for="country" class="form-label">Country</label>
                                                <input type="text" class="form-control" id="country" name="country" required value={{$company->country}} >
                                            </div>
                                            <div class="col-md-12">
                                                <label for="contact-name" class="form-label">Contact Name</label>
                                                <input type="text" class="form-control" id="contact-name" name="contact_name" required value={{$company->contact_name}} >
                                            </div>
                                            <div class="col-md-12">
                                                <label for="contact-title" class="form-label">Contact Title</label>
                                                <input type="text" class="form-control" id="contact-title" name="contact_title" required value={{$company->contact_title}} >
                                            </div>
                                            <div class="col-md-12">
                                                <label for="phone-number" class="form-label">Phone Number</label>
                                                <input type="text" class="form-control" id="phone-number" name="phone_number" required value={{$company->phone_number}}>
                                            </div>
                                            <div class="col-md-12">
                                                <label for="alt-phone-number" class="form-label">Alt Phone Number</label>
                                                <input type="text" class="form-control" id="alt-phone-number" name="alt_phone_number" value={{$company->alt_phone_number}}>
                                            </div>
                                            <div class="col-md-12">
                                                <label for="fax-number" class="form-label">Fax Number</label>
                                                <input type="text" class="form-control" id="fax-number" name="fax_number" value={{$company->fax}}>
                                            </div>
                                            <div class="col-md-12">
                                                <label for="email-address" class="form-label">Email Address</label>
                                                <input type="email" class="form-control" id="email-address" name="email" required value={{$company->email}}>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                    ...
                                    <form id="wizardVerticalForm2" novalidate="novalidate" data-wizard-form="2" enctype="multipart/form-data">
                                        <div class="row g-3">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" class="form-control" id="plant-name" name="plant_name" required value={{$plant->title}}>
                                            </div>
                                            <div class="col-md-12">
                                    ...
                                    <form id="wizardVerticalForm4" novalidate="novalidate" data-wizard-form="4">
                                        <div class="row g-3">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" class="form-control" id="service-rep-name" name="service_rep_name" required value={{$serviceRepresentative->service_rep_name}} >
                                            </div>
                                            <div class="col-md-12">
                                                <label for="service-rep-address" class="form-label">Address</label>
                                                <input type="text" class="form-control" id="service-rep-address" name="address" required value={{$serviceRepresentative->address}} >
                                            </div>
                                            <div class="col-md-12">
                                                <label for="service-rep-city" class="form-label">City</label>
                                                <input type="text" class="form-control" id="service-rep-city" name="city" required value={{$serviceRepresentative->city}} >
                                            </div>
                                            <div class="col-md-12">
                                                <label for="service-rep-state" class="form-label">State/Province</label>
                                                <input type="text" class="form-control" id="service-rep-state" name="state" required value={{$serviceRepresentative->state}} >
                                            </div>
                                            <div class="col-md-12">
                                                <label for="service-rep-zip" class="form-label">Zip/Post Code</label>
                                                <input type="text" class="form-control" id="service-rep-zip" name="zip" required value={{$serviceRepresentative->zip}} >
                                            </div>
                                            <div class="col-md-12">
                                                <label for="service-rep-country" class="form-label">Country</label>
                                                <input type="text" class="form-control" id="service-rep-country" name="country" required value={{$serviceRepresentative->country}} >
                                            </div>
                                            <div class="col-md-12">
                                                <label for="service-rep-contact-name" class="form-label">Contact Name</label>
                                                <input type="text" class="form-control" id="service-rep-contact-name" name="contact_name" required value={{$serviceRepresentative->contact_name}} >
                                            </div>
                                            <div class="col-md-12">
                                                <label for="service-rep-contact-title" class="form-label">Contact Title</label>
                                                <input type="text" class="form-control" id="service-rep-contact-title" name="contact_title" required value={{$serviceRepresentative->contact_title}} >
                                            </div>
                                            <div class="col-md-12">
                                                <label for="service-rep-phone-number" class="form-label">Phone Number</label>
                                                <input type="text" class="form-control" id="service-rep-phone-number" name="phone_number" required value={{$serviceRepresentative->phone_number}}>
                                            </div>
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" class="form-control" id="service-rep-fax-number" name="fax_number" value={{$serviceRepresentative->fax}}>
                                            </div>
                                            <div class="col-md-12">
                                                <label for="service-rep-email-address" class="form-label">Email Address</label>
                                                <input type="email" class="form-control" id="service-rep-email-address" name="email" required value={{$serviceRepresentative->email}} >
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                        ...
                                        <div class="col-12 col-sm-auto">
                                            <div class="text-center text-sm-start">
                                                ...
                                                <p class="text-body-emphasis fs-9">
                                                    Company and Plant information has been successfully updated.
                                                </p>
                                                <a class="btn btn-primary px-6" href="{{route('admin.plants.index')}}">
                                                    Start Over
                                                </a>
                                            </div>
                                        </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            nextBtn.addEventListener('click', function(e) {
                ...
                if (getActiveStep() == 4) {
                    ...
                    formData.append('service_rep_id', {{ $serviceRepresentative->id }});

                    $.post('/api/plant-setup/update-service-representative', Object.fromEntries(formData), function(response) {
                        console.log(response);
                    }).fail(function(response) {
                        console.log(response);
                    });
