    ...
    <div class="iq-sidebar-logo d-flex justify-content-between">
        <a href="{{ url('/') }}" class="header-logo">
            ...
            <div class="logo-title">
                <span class="text-danger text-uppercase">CARE<span class="text-primary ml-1">IUB</span></span>
            </div>
        </a>
            ...
            <ul id="iq-sidebar-toggle" class="iq-menu">
                <li class="active active-menu">
                    <a href="#dashboard" class="iq-waves-effect" data-toggle="collapse" aria-expanded="true">
                        ...
                        <span>Dashboard</span><i class="ri-arrow-right-s-line iq-arrow-right"></i>
                    </a>
