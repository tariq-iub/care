...
class WebhookController extends Controller
{
    ...
    {
        // Check if the 'type' or 'name' metadata exists and return it
        if (isset($payload['data']['object']['metadata']['type'])) {
            return $payload['data']['object']['metadata']['type'];
        }

        if (isset($payload['data']['object']['metadata']['name'])) {
            return $payload['data']['object']['metadata']['name'];
        }
